...
# Save the DataFrame to 'all_lambda_slope.csv' without index
all_slopes_df.to_csv('all_lambda_slope.csv', index=False)
print("All slopes have been saved to all_lambda_slope.csv")
