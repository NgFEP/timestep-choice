...
declare -A nve_steps
nve_steps=( ["0.0005"]=20000000 ["0.001"]=10000000 ["0.002"]=5000000 ["0.0025"]=4000000 ["0.00333333"]=3000000 ["0.004"]=2500000 )
...
morph rpcamp into camp charges and S -> O
 &cntrl
   ...
   timask1             = ':1',
   timask2             = ':2',
   scmask1             = ':1@C,H,H1,H2'       ! softcore region 1
   scmask2             = ':2@C1,O,H3,H4,H5'   ! softcore region 2
   cut                 = 9,
   tishake             = 0,
   iwrap=1, nscm=0,
 /
...
#SBATCH --nodelist=gpu[019-020,023-026]
...
\${amber} -O \\
    ...
    -o \${run_folder}/\${npt}_\${dt}_1.mdout \\
    -r \${run_folder}/\${npt}_\${dt}_1.rst7 \\
    -x \${run_folder}/\${npt}_\${dt}_1.nc \\
    -inf \${run_folder}/\${npt}_\${dt}_1.mdinfo

# Run the NPT simulation
\${amber} -O \\
    -p \${topology} \\
    -c \${run_folder}/\${npt}_\${dt}_1.rst7 \\
    -i \${input_paths}/\${npt}_\${dt}.mdin \\
    -o \${run_folder}/\${npt}_\${dt}_2.mdout \\
    -r \${run_folder}/\${npt}_\${dt}_2.rst7 \\
    -x \${run_folder}/\${npt}_\${dt}_2.nc \\
    -inf \${run_folder}/\${npt}_\${dt}_2.mdinfo

# Run the NPT simulation
\${amber} -O \\
    -p \${topology} \\
    -c \${run_folder}/\${npt}_\${dt}_2.rst7 \\
    -i \${input_paths}/\${npt}_\${dt}.mdin \\
    -o \${run_folder}/\${npt}_\${dt}_3.mdout \\
    -r \${run_folder}/\${npt}_\${dt}_3.rst7 \\
    -x \${run_folder}/\${npt}_\${dt}_3.nc \\
    -inf \${run_folder}/\${npt}_\${dt}_3.mdinfo

# Run the NPT simulation
\${amber} -O \\
    -p \${topology} \\
    -c \${run_folder}/\${npt}_\${dt}_3.rst7 \\
    -i \${input_paths}/\${npt}_\${dt}.mdin \\
    -o \${run_folder}/\${npt}_\${dt}_4.mdout \\
    -r \${run_folder}/\${npt}_\${dt}_4.rst7 \\
    -x \${run_folder}/\${npt}_\${dt}_4.nc \\
    -inf \${run_folder}/\${npt}_\${dt}_4.mdinfo

# Run the NPT simulation
\${amber} -O \\
    -p \${topology} \\
    -c \${run_folder}/\${npt}_\${dt}_4.rst7 \\
    -i \${input_paths}/\${npt}_\${dt}.mdin \\
    -o \${run_folder}/\${npt}_\${dt}_5.mdout \\
    -r \${run_folder}/\${npt}_\${dt}_5.rst7 \\
    -x \${run_folder}/\${npt}_\${dt}_5.nc \\
    -inf \${run_folder}/\${npt}_\${dt}_5.mdinfo


# Run the NVE simulation starting from the NPT output
\${amber} -O \\
    -p \${topology} \\
    -c \${run_folder}/\${npt}_\${dt}_5.rst7 \\
