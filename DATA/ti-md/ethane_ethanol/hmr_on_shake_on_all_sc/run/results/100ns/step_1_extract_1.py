...
if len(sys.argv) >= 4:
    ...
    print("Usage: python extract_data_amber_drift.py <drift|no_drift> <NS|PS> <Energy Components>")
    print("Example: python extract_data_amber_drift.py drift NS Etot_1")
    sys.exit(1)
