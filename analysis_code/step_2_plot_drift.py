...
if len(sys.argv) >= 6:
    ...
    print("Usage: python step_2_plot_drift.py <start> <end> <skip> <image|no_image> <Energy Component>")
    print("Example: python step_2_plot_drift.py 0.0 10.0 10 image Etot_1")
    sys.exit(1)
